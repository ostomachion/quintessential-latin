...
export async function verifyUnifontFontBuild(root){
  ...
  if(manifest.schemaVersion!==1||manifest.customCharacters!==1216||manifest.nativeCompanions!==213||manifest.family!=='Quintessential Latin Unifont')fail('font identity or coverage');
