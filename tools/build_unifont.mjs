...
export function unifontPage(catalogue, source, metadata) {
  ...
  return `<svg class="visually-hidden" aria-hidden="true"><defs><symbol id="unifont-tile-rules" viewBox="0 0 33 33"><path fill="white" fill-rule="evenodd" d="M0 0H33V33H0ZM1 1V32H32V1Z"/><path fill="currentColor" d="${rules}"/></symbol></defs></svg><div class="page-head unifont-heading"><p class="eyebrow">Bitmap reference · Complete repertoire</p><h1>Unifont</h1><p class="lead">All ${glyphs.size.toLocaleString('en-US')} Quintessential Latin characters, drawn at 8 × 16 pixels. ${metadata.inspected.toLocaleString('en-US')} have a current agent inspection; final aesthetic review is separate.</p><div class="inline-links"><a href="unifont/proofs/foundation.html">Review the drawings →</a><a href="unifont/quintessential-latin.hex" download>Download .hex source</a><a href="#unifont-notes">Format &amp; references</a></div></div>
  <div class="unifont-layout"><section class="unifont-charts" aria-label="Unifont code charts"><p class="unifont-instructions">Columns give the leading hexadecimal digits; rows give the final digit. Select a drawn glyph for an enlarged view.</p><p class="unifont-legend"><span><span class="legend-ready" aria-hidden="true"></span> Drawn</span><span><span class="legend-unallocated" aria-hidden="true"></span> Outside allocation</span></p>
